...
class User extends Model {
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    if (phoneNumber != null && (phoneNumber.startsWith(countryCodeAu) || phoneNumber.startsWith(countryCodeBd))) {
      ...
      print("sjdnfjksa 1 in User.fromJson() subphoneNumber: ${phoneNumber} countryCode: $countryCode");
    } else {
      countryCode = predefinedCountryCode;
      print("sjdnfjksa 2 in User.fromJson() subphoneNumber: ${phoneNumber} countryCode: $countryCode");
    ...
    try{
      if (json['e_providers'] != null) {
        eProviders = <dynamic>[];
        json['e_providers'].forEach((v) {
          eProviders.add(v);
        });
      }    }catch(e){
