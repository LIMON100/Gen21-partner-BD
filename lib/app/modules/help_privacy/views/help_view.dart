      ...
      return Scaffold(
        body: RefreshIndicator(
          onRefresh: () async {
            ...
            controller.refreshFaqs(
              showMessage: true,
              categoryId: tabBarController.selectedId.value,
            );
            Get.find<LaravelApiClient>().unForceRefresh();
          },
          child: SingleChildScrollView(
                ...
                children: <Widget>[
                  ...
                  SafeArea(
                    child: Row(
                      children: [
                        BackButton(),
                        SizedBox(width: 8), // Space between button and title
                        Expanded(
                          child: Text(
                            "Help & Support".tr,
                  ...
                  SizedBox(height: 15), // Add spacing after title row
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 5),
                    child: Text(
                      "Most frequently asked questions".tr,
