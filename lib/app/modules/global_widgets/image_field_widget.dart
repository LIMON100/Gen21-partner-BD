  ...
  Future pickImage(ImageSource source, String field, ValueChanged<String> uploadCompleted) async {
    ...
    if (imageFile != null) {
      try {
        ...
        print("sdfnalkfd imageFile size before compressed: ${imageFile.lengthSync()}");
        while(imageFile.lengthSync() > 1100000) {
          imageFile = await compress(imageFile);
          print("sdfnalkfd imageFile size after compressed: ${imageFile.lengthSync()}");
        }
