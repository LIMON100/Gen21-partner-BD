...
class BookingDetailsView extends GetView<BookingControllerNew> {
  ...
  Widget build(BuildContext context) {
    print("jdnfkjsa called");
    return Scaffold(
      bottomNavigationBar: Obx((){
        return controller.isLoading.value? Center(child:  SizedBox(width: 28, height: 28, child: CircularProgressIndicator())):BookingActionsWidgetNew();
      }),
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Align(
                                                  alignment: AlignmentDirectional.centerEnd,
                                                  child: Ui.getPrice(
                                                      controller.booking.value.total_amount - controller.booking.value.total_payable_amount,
                                                      style: Get.textTheme.subtitle2.copyWith(color: Colors.grey)
                                                  ),
                                                ),
                                              ],
  ...
  BookingTitleBarWidget buildBookingTitleBarWidget(Rx<BookingNew> _booking) {
  ...
  Container buildContactCustomer(BookingNew _booking) {
            ...
            if(_booking2.value.status.order != Get.find<GlobalService>().global.value.done)
              Wrap(
                ...
                children: [
                  ...
                  controller.loadingStartChat.value ? CircularProgressIndicator():
                  MaterialButton(
                    onPressed: () {
