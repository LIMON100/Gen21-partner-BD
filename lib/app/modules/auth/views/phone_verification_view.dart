                ...
                if (controller.loading.isTrue) {
                  ...
                  return Column(
                    ...
                    children: [
                     ...
                     Obx(() {
                       print("sjdnfjksa ${controller.enableResend.value}");
                       int seconds = controller.secondsRemaining.value;

                       return controller.enableResend.value? Row(
                       ...
                       ): Center(child: Container(child: Text("Resend OTP option will be visible after ${seconds} ${seconds>1 ? "seconds": "second"}".tr, textAlign: TextAlign.center,), ));
                     })
                    ],
                  );
                }
