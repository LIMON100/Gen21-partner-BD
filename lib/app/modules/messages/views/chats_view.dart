...
class ChatsView extends GetView<MessagesController> {
  ...
  Widget build(BuildContext context) {
    ...
    printWrapped("sjfnsdna ChatsView build() message: ${ controller.message.value.toString()}");
      ...
      appBar: AppBar(
        ...
        title: Obx(() {
          return Text(
            ...
            "${ controller.message.value.users.firstWhere((element) => element.id != _authService.user.value.id, orElse: () => User.fromJson({})).name != ""? controller.message.value.users.firstWhere((element) => element.id != _authService.user.value.id, orElse: () => User.fromJson({})).name : "User" }",
