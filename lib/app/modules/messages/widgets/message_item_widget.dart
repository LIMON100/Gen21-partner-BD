                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                            // this.message.name,
                            "${ this.message.users.firstWhere((element) => element.id != _authService.user.value.id, orElse: () => User.fromJson({})).name != ""? this.message.users.firstWhere((element) => element.id != _authService.user.value.id, orElse: () => User.fromJson({})).name : "User" }",
                    ...
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        message.lastMessage.contains("https://firebasestorage.googleapis.com/")
                            ? Expanded(
                          child: Row(
                            children: [
                              Icon(
                              ...
                              Text(
                                "Photo".tr,
                                style: Get.textTheme.caption.merge(TextStyle(fontWeight: this.message.readByUsers.contains(_authService.user.value.id) ? FontWeight.w400 : FontWeight.w800)),
                              )
                            ],
                          ),
                        )
