  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: Container(
          ...
          child:
          Obx(() {
            return controller.phoneVerificationOnProgress.value ? SizedBox(
            ...
            children: [
              ...
              TextFieldWidget(
                ...
                onSaved: (input) {
                  ...
                  print("jsndjfnjs tempUserEmail: ${controller.tempUser.value.email} input: $input  input !=  controller.user.value.email: ${input != controller.tempUser.value.email}");
              ...
              Obx(() {
                ...
                return TextFieldWidget(
                  ...
                  onSaved: (input) {
                    ...
                    //   controller.isPhoneVerificationNeeded.value = true;
                    // }
                    print("jsndsdfsans inputOldPass: $input ");
                    if (input.length > 0) {
                      controller.isPhoneVerificationNeeded.value = true;
                    }
              ...
              Obx(() {
                return TextFieldWidget(
                  ...
                  onSaved: (input) {
                    ...
                    //   controller.isPhoneVerificationNeeded.value = true;
                    // }
                    print("jsndsdfsans New pass: $input ");
                    if (input.length > 0) {
                      controller.isPhoneVerificationNeeded.value = true;
                    }
              ...
              Obx(() {
                return TextFieldWidget(
                  ...
                  onSaved: (input) {
                    ...
                    //   controller.isPhoneVerificationNeeded.value = true;
                    // }
                    print("jsndsdfsans confirmPassword: $input ");
                    if (input.length > 0) {
                      controller.isPhoneVerificationNeeded.value = true;
                    }
