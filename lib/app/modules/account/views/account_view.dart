      ...
      title: Column(
        ...
        children: [
          Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.logout, size: 24, color: Get.theme.colorScheme.primary),
                  SizedBox(
                    width: 5,
                  ),
                  Text(
                    'Logout'.tr,
                    style: TextStyle(color: Get.theme.colorScheme.primary, fontSize: 16, fontWeight: FontWeight.bold),
                  ),
                ],
              )),
          Container(
          ...
          Container(
            ...
            child: Text(
              ...
              style: TextStyle(color: Get.theme.colorScheme.primary, fontSize: 14, fontWeight: FontWeight.w200),
            ),
          ),
        ],
      ),
            ...
            children: [
              GestureDetector(
                onTap: () async {
                  ...
                  print("skdnjfn1 before HomeController delete call");

                  // _homeController.dispose();
                  Get.delete<HomeController>(force: true);
                  print("skdnjfn1 after HomeController delete call");
                  _homeController.cleanData();
                ...
                child: Container(
                  ...
                  child: Text(
                    "Yes",
                    style: TextStyle(color: Get.theme.colorScheme.primary, fontSize: 14, fontWeight: FontWeight.normal),
                  ),
                ),
              ),
              GestureDetector(
